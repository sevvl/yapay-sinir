...
# Kullanıcıdan gizli katmandaki nöron sayısını alma
gizli_katman_noron_sayisi = int(input("Gizli katmandaki nöron sayısını girin: "))

# Ağırlıkları başlat
ag_giris_gizli = random_agirliklar((x.shape[1], gizli_katman_noron_sayisi))  # Girişten gizli katmana
ag_gizli_cikis = random_agirliklar((gizli_katman_noron_sayisi, y.shape[1]))  # Gizliden çıkış katmanına
...
# Ağı görselleştir
plot_network(giris_sayisi=4, gizli_sayisi=gizli_katman_noron_sayisi, cikis_sayisi=2)
